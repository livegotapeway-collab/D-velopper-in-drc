...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero"><div>
      ...
      <div className="actions"><button className="primary" onClick={() => location.href="/login"}>Rejoindre gratuitement</button><a className="secondary" href="#modules">Voir les fonctionnalités</a></div>
