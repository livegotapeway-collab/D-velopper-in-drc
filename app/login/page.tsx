...
export default function LoginPage(){
  ...
  async function submit(e:FormEvent){e.preventDefault();setLoading(true);setMessage("");
    if(mode==="signup"){
      ...
      setMessage(error?error.message:"Compte créé. Vérifiez votre e-mail pour confirmer votre adresse.");
    }else{
